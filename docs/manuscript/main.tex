...
\title[Tellurium Web]{Tellurium Web - Simulation Service and Database}
\author[Sample \textit{et~al}.]{Matthias König\,$^{\text{\sfb 1,}*}$, Janek Grzegorzewski\,$^{\text{\sfb 1}}$, Kyle Medley\,$^{\text{\sfb 2,}}$, Kiri Choi\,$^{\text{\sfb 2,}}$, Frank Bergmann\,$^{\text{\sfb 3,}}$  and Herbert Sauro\,$^{\text{\sfb 2,}}$}
